...
To show the effect of various identification strength, we first vary the true value of $\phi$ and plot the distribution of $\widehat{\pi}$ in \cref{fig:sim_parameter_estimates}. The reported result is based on $10,000$ observations and \num{250} simulation repetitions. The black lines in the middle of the figures are the true parameter values. The parameter space for $\pi$ is $[-20, 0]$. The estimators sometimes pile up at the boundaries of the parameter space. As expected, this simulation shows that the Gaussian distribution is not a good approximation for the finite-sample distribution of the estimators under weak identification.\footnote{The reason our distributions do not have the same form as is often found in the weak identification literature is because we are in a highly non-linear, non-Gaussian environment, and we simultaneously have boundary issues and weak identification issues. The way in which these various sources of potential bias interact in affecting the approximations is not obvious.}
...
\begin{figure}[htb]
  ...
  \begin{subfigure}[t]{.48\textwidth}
    ...
    \includegraphics[width=\textwidth, height=.7\textwidth]{pi_est_1800_minus_0_point_40.pdf}
  \end{subfigure}
%
  \hfill
%
  \begin{subfigure}[t]{.48\textwidth}
    ...
    \includegraphics[width=\textwidth, height=.7\textwidth]{pi_est_1800_minus_0_point_01.pdf}
  \end{subfigure}
%
  \begin{subfigure}[b]{.48\textwidth}
    \caption[theta with phi = -0.40]{$\theta$ with $\phi = -0.40$}
    \includegraphics[width=\textwidth, height=.7\textwidth]{theta_est_1800_minus_0_point_40.pdf}
  \end{subfigure}
%
  \hfill
%
  \begin{subfigure}[b]{.48\textwidth}
    ...
    \includegraphics[width=\textwidth, height=.7\textwidth]{theta_est_1800_minus_0_point_01.pdf}
  \end{subfigure}
%
\end{figure}
...
For confidence intervals of the three structural parameters, we first compute their joint confidence set based on the conditional QLR test and then project it to each of the component. We also plot a joint confidence sets for the two risk prices, after projecting out $\phi$. We use 1,800 simulations to compute the quantile for the QLR statistic.
...
\begin{figure}[htb]
  ...
  \begin{subfigure}[t]{.32\textwidth}
	...
	\includegraphics[width=\textwidth, height=\textwidth]{qlr_confidence_region_1800.pdf}
  \end{subfigure}
%
  \begin{subfigure}[t]{.32\textwidth}
    \caption{Anderson-Rubin}
    \includegraphics[width=\textwidth, height=\textwidth]{ar_confidence_region_1800.pdf}
  \end{subfigure}
%
  \begin{subfigure}[t]{.32\textwidth}
    \caption{Standard}
...
% We also plot contour plots for both the conditional QLR quantile and the QLR statistic. We do this to aid in interpreting \cref{fig:confidence_region}. We do this by choosing the minimal (maximal) value of the statistic (quantile) for each ($\kappa, \pi$) pair. By defining it this way, \Cref{fig:confidence_region} is simply the region where the statistic exceeds the quantile. As we can see in these graphs both graphs are relatively smooth and likely uni-modal. 

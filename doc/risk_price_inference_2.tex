...
% \Cref{sec:simulation} show that the method works well in simulation, and \Cref{sec:empirical} provides estimates of the risk prices in an empirical application. \Cref{sec:conclusion} concludes. 

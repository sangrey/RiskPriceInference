...
\begin{frame}[c]{Literature Review}
    ...
    \begin{itemize}
        \item  The empirical evidence on the market return risk price is inconclusive, \parencite{lettau2010measuring}. 
%
...
Obtain the $1-\alpha $ conditional quantile of the QLR statistic, denoted $c_{1-\alpha }(r,\theta _{0})$: 
\bigskip

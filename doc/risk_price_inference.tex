...
\begin{align}
    ...
    m_0(\theta, \pi)  &= \beta_{\PP}(\theta) + a_{\PP}(\alpha_{\PP}(\theta) + \pi) 
\end{align}
...
\begin{align}
    \E \left[ \exps*{ - \theta_1 \sigma^2_{t+1} - (\theta_2 - 1) r_{t+1} } \mvert \F_{t} \right]
        &= \exps*{- m_0(\theta, \pi) - m_1(\theta, \pi)}
    \intertext{The right-hand side of the above equation is the product of the Laplace transforms of $r_{t+1}$ and
        $\sigma^2_{t+1}$.}
    \E \left[\exps*{- \theta_1 \sigma^2_{t+1} - (\theta_2 - 1) r_{t+1}}  \mvert \F_{t} \right]
        &= \exps*{ - m_0(\theta, \pi) - m_1(\theta, \pi) } 
\end{align}

...
\purple{I am switching signs from above.}
...
\purple{I am missing an It\^{o}'s formula correction term below. This is why I am adding a $\tau-$ to the one
    $\sigma^2(\tau)$ and not to the other.} 


\begin{alignat}{2}
    \dif p(\tau) &=\ && \psi(\tau-) \sigma^2(\tau) \dif \tau + \beta(\tau-) \sigma^2(\tau-) \dif \tau + \gamma(\tau-)
        \dif \tau + \sqrt{1 - \phi(\tau-)^2} \sigma(\tau-) \dif W(\tau)   \\

...
We will also assume that the unconditional mean of $z_t$ agrees with that of $\sigma^2_{t+1}$. 
...
% We can solve for $\E\left[ \sigma^2_{t+1} \mvert z_t\right]$ by differentiating the logarithm
% \cref{defn:physical_model} because it defines a conditional cumulant function.

% \begin{align}
%     \label{eqn:vol_mean}
%     \E\left[\sigma^2_{t+1} \mvert z_t\right] &= \alpha_{\PP}'(0) z_t + \beta_{\PP}'(0) \\
%     \label{eqn:vol_var}
%     \Var\left[\sigma^2_{t+1} \mvert z_t\right] &= \alpha_{\PP}''(0) z_t 
% \end{align}

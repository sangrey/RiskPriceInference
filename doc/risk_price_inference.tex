...
\subsection{Derivation of the Moment Conditions}
...
\subsection{Pricing the Variance}
...
\purple{To show the claim here, I take \textcite[p.15, 3.9a]{khrapov2016affine}, take Ito's lemma over $\alpha$,
    and, then take integrals. Get we're identified from the variance $\iff$ $\psi \neq (1 - \phi^2) (\pi - 1/2)$. 
    Then I further claim, that we do not want to use higher moments to avoid biasing our estimates....}
